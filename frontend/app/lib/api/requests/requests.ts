...
export function createRootHttpRequest(name: string, data: CreateRequestDto): Promise<RequestDto> {
...
export function createRootGrpcRequest(name: string, data: CreateRequestDto): Promise<RequestDto> {
